...
void ageGender()
{
    string faceProto = "./AgeGender/opencv_face_detector.pbtxt";
    string faceModel = "./AgeGender/opencv_face_detector_uint8.pb";

    string ageProto = "./AgeGender/age_deploy.prototxt";
    string ageModel = "./AgeGender/age_net.caffemodel";

    string genderProto = "./AgeGender/gender_deploy.prototxt";
    string genderModel = "./AgeGender/gender_net.caffemodel";
   ...
   /* if (argc > 1)
    ...
    //while(waitKey(1) < 0) {
      ...
      Mat frame;
      //cap.read(frame);
	  frame = imread("./AgeGender/images/chao1.jpg", IMREAD_COLOR);
      if (frame.empty())
      {
          waitKey();
          //break;
